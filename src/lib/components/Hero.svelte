...
<section id="heroHome" class="px-4 md:px-20 pb-16 bg-no-repeat bg-cover relative pt-24 lg:bg-center bg-right bg-black bg-blend-overlay bg-opacity-60" style="background-image: url('https://static.shuffle.dev/uploads/files/ec/ec578d7e076a0dfd4b92738b77ade3a71968172c/3860.jpg')">
      ...
      <div class:hidden={!mobileNavOpen} class="hidden fixed top-0 left-0 bottom-0 w-5/6 max-w-xs z-50">
        ...
        <nav class="relative p-8 w-full h-full bg-white overflow-y-auto">
          ...
          <div class="flex flex-col gap-4">
            ...
            <a href="#" class="rounded-full bg-black px-5 py-3 h-14 hover:bg-accent focus:bg-hover focus:ring-4 focus:ring-green-200 inline-flex items-center justify-center gap-2 transition duration-200">
    ...
    <div class="flex flex-wrap justify-center gap-4 mb-32">
      <a href="#getQuote" class="bg-accent h-16 rounded-full px-6 py-4 inline-flex items-center justify-center gap-2 tracking-tight hover:bg-hover focus:bg-green-500 focus:ring-4 focus:ring-green-200 transition duration-200">
    ...
    <div class="flex flex-wrap">
      <div class="w-full lg:w-1/3">
        <a href="#" class="inline-block w-full py-3 border-b-2 border-white">
          <p class="text-white font-semibold">Custom Software Development</p>
        </a>
      </div>
      <div class="w-full lg:w-1/3">
        <a href="#" class="inline-block w-full py-3 border-b-2 border-white border-opacity-10 hover:border-opacity-100 transition duration-200">
          <p class="text-white font-semibold lg:text-center">Web Development</p>
        </a>
      </div>
      <div class="w-full lg:w-1/3">
        <a href="#" class="inline-block w-full py-3 border-b-2 border-white border-opacity-10 hover:border-opacity-100 transition duration-200">
          <p class="text-white font-semibold lg:text-right">IT Technical Support</p>
        </a>
      </div>
    </div>
  </section>