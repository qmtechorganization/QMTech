...
<section class="px-4 md:px-24 lg:py-10 content-center container mx-auto">
    <div class="container flex flex-wrap mx-auto -m-4">
      <div class="w-full lg:w-1/3 p-4" use:reveal>
        <p class="tracking-tight text-accent font-medium mb-6">{$_('webHosting.tagline')}</p>
        <h1 class="font-heading tracking-tight text-4xl md:text-6xl font-medium mb-6 max-w-xs md:max-w-lg">{$_('webHosting.header')}</h1>
        <p class="tracking-tight text-body text-lg max-w-md mb-12 lg:mb-32">{$_('webHosting.subheader')}</p>
        <div class="w-full h-px bg-gray-200 dark:bg-white/20 mb-14"></div>
        <p class="flex items-center tracking-tight text-lg font-semibold mb-2">
          {$_('webHosting.protected')} <img class="w-24 ml-6 mb-4 invert dark:invert-0" src="/images/CF_logo_stacked_whitetype.png" alt="cloudflare">
      </p>
      
      </div>
      <div class="w-full lg:w-2/3 p-4" use:reveal={{ delay: 150 }}>
        <div class="flex lg:justify-end">
          <div class="overflow-x-auto ">
            <div class="flex lg:flex-row flex-col gap-6">
              <div class="lg:w-80 w-full flex-shrink-0">
                <div class="rounded-2xl border border-gray-200 dark:border-white/10 p-7 rounded-4xl">
                  <p class="tracking-tight text-lg font-semibold text-center">
                    {$_('webHosting.starterPack.title')} <br>
                  </p>
                  ...
                  <ul class="flex flex-col gap-4 mb-8">
                    <li class="flex items-center gap-2">
                      ...
                      <span class="tracking-tight font-medium">
                        {$_('webHosting.starterPack.perks.websites')} <br>
                      </span>
                    </li>
                    <li class="flex items-center gap-2">
                  ...
                  <a href="#getQuote" class="bg-accent hover:bg-hover h-16 w-full border border-gray-200 rounded-full px-5 py-4 inline-flex items-center justify-center tracking-tight font-bold transition duration-200 text-white">{$_('webHosting.getStarted')}</a>
                </div>
              </div>
              <div class="lg:w-80 w-full flex-shrink-0">
                <div class="rounded-2xl border border-gray-200 dark:border-white/10 p-7 rounded-4xl">
                  <p class="tracking-tight text-lg font-semibold text-center">{$_('webHosting.smallBusiness.title')}</p>
                  ...
                  <a href="#getQuote" class="bg-accent h-16 w-full border border-gray-200 rounded-full px-5 py-4 inline-flex items-center justify-center hover:bg-hover focus:bg-gray-100 focus:ring-4 focus:ring-gray-200 tracking-tight font-bold transition duration-200 text-white">{$_('webHosting.getStarted')}</a>
                </div>
              </div>
            </div>
          </div>
